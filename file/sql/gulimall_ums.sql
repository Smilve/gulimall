...
CREATE TABLE `ums_member`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '会员' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ums_member
-- ----------------------------
INSERT INTO `ums_member` VALUES (1, 1, 'smilve', '$2a$10$IPhMwb4NilAK7QFUKD8KO.jcogh5YOSx5k6gUNg0oF8xz47hQ/.ti', 'smilve', '19822964684', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
-- ----------------------------
INSERT INTO `ums_member_level` VALUES (1, '普通会员', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member_level` VALUES (2, '青铜会员', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member_level` VALUES (3, '黄金会员', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
-- ----------------------------
INSERT INTO `ums_member_receive_address` VALUES (1, 9, '老王', '123456789', '123456', '四川省', '成都市', '双流区', '成都市大学', NULL, 1);
INSERT INTO `ums_member_receive_address` VALUES (2, 9, '老c', '878274823', '123213', '江苏省', '苏州市', 'test', '苏州大学', NULL, 0);
